...
export const FacebookProfileView: React.FC<FacebookProfileProps> = ({ resultId, onClose, persona = 'meredith', condition, prolificParams }) => {
      ...
      <div style={{ backgroundColor: 'white', borderBottom: '1px solid #ddd', position: 'sticky', top: 41, zIndex: 100, height: '56px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: isMobile ? '0 8px' : '0 16px' }}>
        ...
        <div style={{ display: 'flex', gap: '8px', flex: isMobile ? 'none' : 1, justifyContent: 'flex-end', alignItems: 'center' }}>
          ...
          <div style={{ position: 'relative' }}>
            <img src={getFakeImageUrl(resultId, 'avatar')} style={{ width: '40px', height: '40px', borderRadius: '50%', cursor: 'pointer', filter: 'blur(12px) saturate(1.5)' }} alt="" />
                  ...
                  <div style={{ display: 'flex', gap: '12px' }}>
                    ...
                    <div>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
                        ...
                        <span style={{ color: '#65676b' }}>updated her profile picture.</span>
                      </div>
